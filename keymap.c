 ...
 *
 * ,--------------------------------------------------.                 ,--------------------------------------------------.
 * | DEL    |CLeft |CDown | CUp  |CRight| CmdR |  ESC |                 |  ESC |  F6  | Prev | Play | Next | Exit |Backspac|
 * |--------+------+------+------+------+-------------|                 |------+------+------+------+------+------+--------|
...
[MAC] = LAYOUT_ergodox_pretty(
  KC_DEL,   C(KC_LEFT), C(KC_DOWN), C(KC_UP), C(KC_RIGHT),  G(KC_R), KC_ESC,        KC_ESC,   KC_F6, KC_MPRV, KC_MPLY, KC_MNXT, G(KC_Q), KC_BSPC,
 ...
 *
 * ,--------------------------------------------------.                 ,--------------------------------------------------.
 * |        |  F1  |  F2  |  F3  |  F4  |  F5  |  ESC |                 |  ESC |  F6  |  F7  |  F8  |  F9  | F10  |Backspac|
 * |--------+------+------+------+------+-------------|                 |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  |Toggle|                 |Toggle|   Y  |   U  |   I  |   O  |   P  | Enter  |
 * |--------+------+------+------+------+------|Lower |                 |Raise |------+------+------+------+------+--------|
 * | LCtrl  |   A  |   S  |   D  |   F  |   G  |------|                 |------|   H  |   J  |   K  |   L  |   ;  |   '    |
...
[SYMB] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS, KC_TRNS, KC_ASTR, KC_MINS, KC_PLUS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_PIPE, KC_LCBR, KC_RCBR, KC_TRNS,
...
[ARROW] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, G(KC_TRNS), G(KC_TRNS), G(KC_TRNS), G(KC_TRNS), KC_TRNS, KC_TRNS,
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                            KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS, KC_TRNS,
