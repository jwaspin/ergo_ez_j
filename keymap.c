...
[LIX] = LAYOUT_ergodox_pretty(
  DF(WIN),  KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_F5, KC_ESC,               KC_ESC,  G(KC_T), KC_MPRV, KC_MPLY, KC_MNXT, A(KC_F4), KC_BSPC,
  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,   KC_T,  TG(ARROW),            KC_HYPR, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_QUOT,
  KC_LCTRL, KC_A,    KC_S,    KC_D,    KC_F,   KC_G,                                 KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_ENT,
  KC_LSPO,  KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,  MO(ARROW),            KC_MEH,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSPC,
...
[SYMB] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, KC_MINS, KC_PLUS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_LCBR, KC_ASTR, KC_PIPE, KC_RCBR, KC_GRV,
...
[ARROW] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS,                       KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_TRNS, KC_MPLY,
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
